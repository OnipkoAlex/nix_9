...
import ua.com.alevel.service.impl.AdminServiceImpl;
...
public class AdminController {
            ...
            try {
                ...
                if (clientService.sizeOf() > 1) {
                    ...
                    for (Client i : clients) {
                        if (i.getEmail().equals(email) && !i.getId().equals(access.getId()))
                            notVacantEmail = true;
                        if (i.getPhone().equals(phone) && !i.getId().equals(access.getId()))
                            notVacantPhone = true;
                    }
                }
                if (notVacantEmail) {
            ...
            try {
                ...
                if (accessService.sizeOf() > 0) {
                    for (Access i : accesses) {
                        if (i.getLogin().equals(login) && !i.getId().equals(access.getId()))
                            notVacantLogin = true;
                    }
                }
                if (notVacantLogin) {
    ...
    public static void showClientsOrders(Access access) {
        List<Order> orders = orderService.findByClientId(access.getId());
